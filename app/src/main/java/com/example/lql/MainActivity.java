...
import com.example.lql.bean.UserInfo;
import com.example.lql.database.UserDBHelper;
import com.example.lql.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, OnCheckedChangeListener {
    ...
    private Button btn_zhuce;//声明一个注册按钮控件对象
    ...
    private String[] typeArray = {"个人用户", "公司用户","李奇霖_17990037"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_zhuce.setOnClickListener(this);//注册
    ...
    public void onClick(View v) {
        ...
        }else if(v.getId() == R.id.btn_zhuce){//如果点击注册按钮
